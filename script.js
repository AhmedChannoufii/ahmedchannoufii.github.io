...
const translations = {
  en: {
    ...
    "proj.understanding.title": "🔍 Understanding the 3 Test Levels",
    ...
    "proj.smart.title": "🛡️ Smart System Features",
    "proj.smart.feature1": "Automatic next-test suggestion — After each successful test, the system automatically suggests the next test to perform based on the board's history.",
    "proj.smart.feature2": "Error prevention — If the user attempts an incorrect action (wrong order, invalid step), the system blocks it and stops the process immediately.",
    "proj.smart.feature3": "Smart filtering — For each test type, the system automatically filters the available machines, boards, and operators to show only the correct options for that specific test.",
    "proj.rbac.role": "Role",
  ...
  fr: {
    ...
    "exp.pfe.b3": "Entraînement et comparaison de quatre modèles de machine learning (Régression Logistique, Random Forest, SVM, XGBoost) ; sélection de XGBoost comme modèle final, atteignant 96% d'exactitude, 83% de précision, 93% de rappel et 88% de F1-score sur la classe churn.",
    "exp.pfe.b4": "Validation du modèle final sur des données clients réelles, confirmant une performance solide et stable.",
    "exp.pfe.b5": "Développement d'une application web Flask avec tableau de bord interactif et KPIs dynamiques pour la visualisation des prédictions.",
    "exp.pfa.title": ".NET Developer (PFA)",
